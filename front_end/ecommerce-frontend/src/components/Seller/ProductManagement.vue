<!-- /components/Seller/ProductManagement.vue -->
  ...
  <div class="products-dashboard">
    <div class="dashboard-header">
      ...
      <div class="header-actions">
        <router-link to="/seller/products/add" class="add-product-button">
...
async function fetchProducts() {
  try {
    const response = await api.get('/seller/products'); // Seller-specific endpoint
...
async function updateStock(product) {
  try {
    ...
    // API call
    await api.patch(`/seller/products/${product.id}/stock`, { stock: newStock });
