...
const isSeller = (req, res, next) => {
  ...
  if (req.user && req.user.role === 'seller') {
    console.log('User is an approved seller. Proceeding...');
    next();
  } else {
    console.log('User is not an approved seller. Access denied.');
    return res.status(403).json({
...
module.exports = { authenticateToken, isAdmin, isSuperAdmin, isSeller };